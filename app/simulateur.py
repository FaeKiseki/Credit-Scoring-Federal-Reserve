...
# Title
st.title("\U0001F4CA U.S. Credit Trends Dashboard (2012–2024)")
...
# KPI Cards
st.markdown("### \U0001F50D Key Indicators")
...
with col1:
    fig1 = px.line(df, x=df.index, y='Total Balances ($Billions)', title="\U0001F4C8 Total Credit Card Balances Over Time")
...
with col2:
    fig2 = px.line(
        ...
        title="\U0001F4CA Credit Utilization Rates (P50, P75, P90)"
    )
...
with col3:
    fig3 = px.line(df, x=df.index, y='Current Credit Score (50th percentile)', title="\U0001F9E0 Median Credit Score Over Time")
...
# Payment Behavior
st.markdown("### \U0001F4B5 Payment Behavior Over Time")
fig5 = px.line(
    df, x=df.index,
    y=[
